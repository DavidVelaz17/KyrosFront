...
export function LogsTable({ data, columns }: LogsTableProps) {
  const [sorting, setSorting] = useState<SortingState>([]);
  // Orden por defecto: el inicio de sesión más reciente arriba (id autoincremental = orden real
  // en que se crearon los registros).
