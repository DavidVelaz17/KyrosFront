...
import { STUDENT_COLUMN_CATALOG } from "@/lib/constants/student-columns";
...
export function ColumnVisibilityMenu({ visibility, onChange }: ColumnVisibilityMenuProps) {
  ...
  return (
    ...
    >
      <div className="max-h-80 overflow-y-auto px-1 py-1">
        ...
        {STUDENT_COLUMN_CATALOG.map((column) => (
          <label
            key={column.id}
